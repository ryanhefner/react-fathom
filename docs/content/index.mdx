...
- [React](/react) — Basic React setup with hooks and components
- [Next.js](/nextjs) — App Router and Pages Router integration
- [React Native](/react-native) — Mobile apps with offline queuing
